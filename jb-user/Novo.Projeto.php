...
if ($_POST['cadastrar']) {
	...
	if (!empty($foto["name"])) {
		...
		if (count($error) == 0) {
			...
			$sql = mysql_query("INSERT INTO projeto VALUES ('', '".$autor."', '".$username."', '".$menu."', '".$titulo."', '".$desc."', '".$nome_imagem."', '".$demo."', '".$projeto."')");
		
			// Se os dados forem inseridos com sucesso
			if ($sql){
				header("Location: Novo.Projeto");
			}
		}
...
<div id="main">
  <div class="clear"></div>
  <div class="full_w">
    <div class="h_title">Add Novo Projeto</div>
    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data" name="cadastro">
      ...
      <div class="element">
        ...
        <input id="projeto" name="projeto" type="text" class="text " placeholder="URL de Download" />
      </div>
      <div class="element">
        <label for="projeto">Demonstra&ccedil;&atilde;o</label>
        <input id="demo" name="demo" class="text " placeholder="URL de Demonstra&ccedil;&atilde;o"/>
      </div>
      <div class="element">
